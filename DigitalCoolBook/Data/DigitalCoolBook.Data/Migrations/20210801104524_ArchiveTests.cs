...
{
    public partial class ArchiveTests : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GradeId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    ArchivedTestId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArchivedTests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ArchivedTests_AspNetUsers_TeacherId",
                        column: x => x.TeacherId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ArchivedTests_Lessons_LessonId",
                        column: x => x.LessonId,
                        principalTable: "Lessons",
                        principalColumn: "LessonId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArchivedTests_LessonId",
                table: "ArchivedTests",
                column: "LessonId");

            migrationBuilder.CreateIndex(
                name: "IX_ArchivedTests_TeacherId",
                table: "ArchivedTests",
                column: "TeacherId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_ArchivedTestId",
                table: "AspNetUsers",
                column: "ArchivedTestId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AspNetUsers_ArchivedTests_ArchivedTestId",
                table: "AspNetUsers",
                column: "ArchivedTestId",
                principalTable: "ArchivedTests",
                principalColumn: "Id",
                onDelete: ReferentialAction.Restrict);
